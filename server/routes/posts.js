...
router.get("/", async (req, res) => {
    logger.debug("GET /posts with origins: " + req.origins)
...
router.get("/:id", async (req, res) => {
    logger.debug("GET /posts/:id with origins: " + req.origins)
...
router.post("/", async (req, res) => {
    logger.debug("POST /posts with origins: " + req.origins)
...
router.delete("/:id", async (req, res) => {
    logger.debug("DELETE /posts/:id with origins: " + req.origins)
